...
denomidado L1 Terminal Fault (L1TF) pela Intel, explora uma vulnerabilidade
na execução especulativa, a mesma explorada pelo Meltdown e permite ao 
atacante extrair segredos do enclave enquanto estão no cache L1 sem fazer
suposições sobre o código enclave da vítica e sem precisar de acesso ao 
...
A Intel liberou mitigações em microcódigo, contudo há impacto na performance
